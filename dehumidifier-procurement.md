# Industrial Dehumidifier Procurement Guide
...
**✅ RECOMMENDED SOLUTION: Condensate Pump**

All commercial dehumidifiers can use a **condensate pump** to move water to a remote drain. This eliminates manual emptying and enables 24/7 unattended operation.

### Condensate Pump Options:

**Built-in Pumps** (Available on some models):
- Can pump water **15-20 feet vertically** or **100+ feet horizontally**
- Uses small tubing (3/8" or 1/2") that can route through walls, ceiling, or under doors
- **Automatic operation** - no intervention needed
- **Cost**: Often built-in or $100-300 add-on

**External Condensate Pumps** (Universal solution):
- **Little Giant VCMA-15ULS** (~$150): 15 ft lift, reliable
- **Hartell GPM-2** (~$180): 20 ft lift, commercial grade  
- **Liberty Pumps LCU-20** (~$200): High capacity, 20 ft lift

### For Your Lab:
1. Install dehumidifier with gravity drain port
2. Connect to condensate pump
3. Run 3/8" tubing through wall/ceiling to adjacent lab's drain
...
- **Quest 155**: Built-in drain port, add external pump ($150-200)
- **Aprilaire 1870**: Drain port included, add external pump  
- **AlorAir HD55/HD90**: Built-in pump option available (WiFi models)
- **Santa Fe Ultra V155**: Gravity drain + optional pump kit

---

## Recommended Products

### 1. Santa Fe Ultra V155 (Recommended for Large Labs)

**Specifications:**
- **Water Removal Capacity**: 155 Pints/day (19.3 Gallons)
- **Coverage Area**: Up to 3,500 sq. ft. (35,000 cubic feet)
- **Energy Efficiency**: 7.1 Pints/kWh
- **CFM Blower**: 435 CFM @ 0.0" WC; 322 CFM @ 0.6" WC
- **Operating Temperature Range**: 34°F Min., 105°F Max.
- **Electrical Requirements**: 115V, 7.1 Amps, 1,144 Watts
- **Filtration**: MERV-13
- **Refrigerant**: R454B (environmentally friendly)
- **Dimensions**: 14.35"W x 24"H x 39.25"D
- **Weight**: 112 lbs
...
### 2. Quest 155 High-Efficiency Dehumidifier

**Specifications:**
- **Water Removal Capacity**: 155 pints/day (at 80°F, 60% RH)
- **Energy Efficiency**: 8.5 Pints/kWh
- **Supply Voltage**: 110-120V (standard outlet)
- **Current Draw**: ~6.9 Amps
- **Installation**: Overhead or freestanding, compact design
- **Digital Controls**: Onboard digital control interface for precise humidity management
- **Filtration**: MERV 13-rated (removes particles and microorganisms)
...
### 3. Aprilaire 1870 XL Pro (Whole-Building Solution)

**Specifications:**
- **Water Removal Capacity**: 130 pints per day (16 gallons)
- **Coverage Area**: Up to 7,200 sq. ft.
- **Electrical Requirements**: 120VAC, 1-phase, 60 Hz, 8.3 Amps
...
- **Operating Conditions**:
  ...
  - Ventilation: 40°F–140°F, 0%–99% RH (non-condensing)
- **Dimensions**: 19.5"W x 18.75"H x 30"L
- **Weight**: 113-114 lbs
- **Noise Level**: 50 dBA (ducted)
- **Filtration**: Washable MERV 8 filter
- **Refrigerant**: R410A
- **Features**: Top or end air discharge orientation, digital control, 10-inch duct collars
...
### 4. AlorAir Sentinel HD55 (Budget-Friendly Option)

**Specifications:**
- **Water Removal Capacity**: 113 pints/day
- **Coverage Area**: Up to 1,200 sq. ft.
- **Electrical Requirements**: 115V
- **Features**: 
  - Bucketless design with continuous drain
  - Auto defrost
...
**Where to Buy:**
- **WebstaurantStore**: [AlorAir Sentinel HD90](https://www.webstaurantstore.com/)
- **National Allergy**: [AlorAir Sentinel HD90](https://www.natlallergy.com/alorair-sentinel-hd90-90-pint-dehumidifier-for-basements-and-crawl-spaces.html)
- **AMG Air**: [AlorAir Sentinel HD90 Dehumidifier](https://www.amgair.com/alorair-sentinel-hd90-dehumidifier.html)
- **Estimated Price**: $1,047

---

### 6. Santa Fe Compact70 (Small Space Option)

**Specifications:**
- **Water Removal Capacity**: 70 Pints/day
- **Coverage Area**: Up to 1,800 sq. ft.
- **Energy Efficiency**: 2.4 L/kWh
- **Electrical Requirements**: 5.1 Amps
- **Dimensions**: 12" tall, 12" wide (compact, fits in small spaces)
- **Filtration**: MERV-11 standard
- **Features**: Optional hanging kits, caster kits, condensate pumps, duct kits available

**Where to Buy:**
- **Flexomeric**: [Santa Fe Compact70](https://www.flexomeric.com/santa-fe-compact70-dehumidifier.html)
- **Manufacturer**: [Santa Fe Products](https://www.santa-fe-products.com/solutions/commercial/)
- **Estimated Price**: $1,500 - $2,000

---

## Additional Commercial/Industrial Options

### Ebac Industrial Dehumidifiers
- **CD30 Industrial Dehumidifier**: 10 Litre/Day, 240V (£597.00 / $750)
- **CD85 Digital Controller**: 35 Litre/Day, 240V (£1,308.00 / $1,650)
- **WM150-D with Digital Humidity Control**: $3,500
- **DD1200 Industrial Desiccant**: $17,133 (high-capacity industrial)

**Where to Buy:**
- **Orion Air Sales**: [Industrial & Scientific Dehumidifiers](https://www.orionairsales.co.uk/industrial-and-scientific-dehumidifiers-246-c.asp)
- **MSC Direct**: [Ebac Dehumidifiers](https://www.mscdirect.com/product/details/01923911)

---

## Condensate Pump Recommendations

**For labs without floor drains** - Essential accessories for continuous operation:

### Recommended External Condensate Pumps:

**1. Little Giant VCMA-15ULS** (Best Value)
- **Price**: ~$150
- **Lift**: 15 feet vertical
- **Flow**: 1 gallon/minute  
- **Features**: Auto on/off, safety switch, quiet operation
- **Where to Buy**: Amazon, Home Depot, SupplyHouse
- **Best for**: Most installations, proven reliability

**2. Hartell GPM-2** (Commercial Grade)
- **Price**: ~$180
- **Lift**: 20 feet vertical
- **Flow**: 2 gallons/minute
- **Features**: Heavy-duty, built for 24/7 operation
- **Where to Buy**: HVAC supply houses
- **Best for**: High-capacity installations

**3. Liberty Pumps LCU-20** (Premium)
- **Price**: ~$200
- **Lift**: 20 feet vertical, 230 feet horizontal
- **Flow**: High capacity
- **Features**: Corrosion-resistant, long life
- **Where to Buy**: Plumbing supply, Amazon
- **Best for**: Long horizontal runs to adjacent lab

### Installation Kit (Additional $50-100):
- 3/8" or 1/2" vinyl tubing (clear for visibility)
- Tubing clamps and fittings
- Check valve (prevents backflow)
- Wall penetration collar (if routing through wall)
- Mounting bracket for pump

### Built-in Pump Options:
- **AlorAir Sentinel HD55 WiFi**: Has built-in pump (~$503-628)
- **Some Quest models**: Optional factory-installed pump
- Saves $150-200 on external pump
...
### 5-Year Total Cost of Ownership (Equipment + Energy)
...
### For BYU Vertical Cloud Lab (Original recommendations):
...
- **⚠️ Note**: Requires ducting - may not be ideal for ventilated room
...
1. **MERV-13 Filtration** (Quest 155, Santa Fe Ultra V155) - Essential for maintaining clean air in labs
2. **Energy Efficiency** - Higher pints/kWh reduces operating costs
3. **Digital Controls** - Precise humidity setpoint management
4. **Continuous Drainage** - Essential for 24/7 operation
5. **Auto-Restart** - Maintains operation after power interruptions
6. **Low Noise Operation** - Important for occupied lab spaces
7. **Temperature Range** - Should operate reliably at lab temperatures
8. **Warranty** - 5-year warranty preferred for institutional use

---

## Installation Considerations

### For Your Lab (No Floor Drain):

1. **Drainage Solution - CRITICAL**:
   - ✅ **Install condensate pump** to route water to adjacent lab's drain
   - Run 3/8" or 1/2" tubing through wall/ceiling/under door
   - Pumps can lift water 15-20 feet vertically or 100+ feet horizontally
   - **Recommended pumps**: Little Giant VCMA-15ULS ($150), Hartell GPM-2 ($180)
   - Budget $150-200 for external pump + $50-100 for tubing/installation

2. **Electrical**: 
   - All recommended models use standard 115-120V
   - Verify dedicated 15A circuit at installation location
   - Quest 155: 6.9A, AlorAir HD55: ~7.5A

3. **Airflow**: 
   - Ensure adequate clearance for air intake/exhaust (12-18" minimum)
   - **For ventilated room**: Freestanding units (Quest 155, AlorAir) are better than ducted
   - Avoid blocking existing room ventilation

4. **Ducting Considerations**: 
   - **NOT recommended** for your already-ventilated room
   - Ducted systems (Aprilaire 1870) interfere with existing ventilation
   - Freestanding units work better in ventilated spaces

5. **Placement**: Consider proximity to:
   - Sensitive equipment requiring humidity control
   - Electrical outlets (within 9 feet for Quest 155's power cord)
   - Route to adjacent lab for pump discharge
   - Air circulation patterns - don't block vents
...
1. **✅ Consult with Tonio**: Get recommendations based on facility experience and any institutional preferences

2. **Measure Lab Dimensions**: Calculate total square footage and ceiling height

3. **Plan Condensate Pump Route**: 
   - Identify best path from dehumidifier location to adjacent lab's drain
   - Measure distance and elevation change
   - Determine if routing through wall, ceiling, or under door

4. **Verify Electrical**: 
   - Confirm 120V outlet location and circuit capacity
   - Consider dedicated circuit if on shared breaker

5. **Get Educational/Institutional Pricing**:
   - Contact vendors with BYU purchasing info
   - Many offer educational institution discounts (10-20%)
   - **Quest**: Contact through [Quest Climate](https://www.questclimate.com/)
   - **AlorAir**: Check [AlorAir Crawlspace Store](https://aloraircrawlspace.com/) for promotions

6. **Budget Summary**:
   - Equipment: $503 (AlorAir) to $3,300 (Quest 155)
   - Condensate Pump: $150-200 (if not built-in)
   - Tubing/Fittings: $50-100
   - Installation (if needed): $200-500
   - **Total estimated**: $700-$4,000 depending on model

7. **Timeline**:
   - Procurement approval: 1-2 weeks
   - Equipment delivery: 1-2 weeks  
   - Installation: 1 day
   - **Total**: 3-5 weeks from approval to operation
