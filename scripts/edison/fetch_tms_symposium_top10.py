#!/usr/bin/env python3
"""Poll and fetch the Edison ANALYSIS symposium-top10 task, writing the answer
and full task dump into edison-trajectories/tms-symposium-top10/.

Usage:
    EDISON_API_KEY=... python scripts/edison/fetch_tms_symposium_top10.py [--once]
"""
...
def main() -> None:
    ...
    base = TRAJ / f"tms-symposium-top10-{task_id}"
    base.with_suffix(".md").write_text(answer)
    (TRAJ / f"tms-symposium-top10-{task_id}.json").write_text(json.dumps(dump, indent=2, default=str))
