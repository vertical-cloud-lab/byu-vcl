...
def _iso(epoch):
    """Millisecond-resolution UTC, the form the run JSON and MongoDB both use."""
            ...
            while time.time() < deadline:
                for topic, raw in self._drain():
                    ...
                    return {
                        ...
                        # The measurement is bracketed by these two: the board
                        # integrates somewhere between the command going out and
                        # the answer coming back, nearer the latter. Recording
                        # both keeps the uncertainty visible instead of implying
