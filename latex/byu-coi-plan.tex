...
\textbf{Why this is being proposed.} The arrangement is put forward because
the research group and its students stand to gain from it. Research students
would get hands-on time on instruments the university would find hard to buy,
under an equipment agreement BYU signs (6.4). Sponsored agreements negotiated
independently of the Faculty Member would bring new research funding for
student wages, equipment, and student travel (4.1). Students would get
industry experience: internships, applied problems, and jobs (5.4). And
because the Company's model is open source, student work stays publishable, so
a graduate thesis, a paper, or a conference talk is not held up by a sponsor's
confidentiality (7.1). A benefit is not by itself a reason to approve a
conflict, and each of these depends on an approval or a condition set out
below.
