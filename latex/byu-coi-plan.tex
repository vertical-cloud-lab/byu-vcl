...
% ------------------------------------------------------------------- band A
\planband{A. Role and principal duties of the Faculty Member}{}

This activity is put forward because
there is significant potential for benefits to the research group and its students. This includes potential for research students
to have hands-on time on instruments that would otherwise be difficult to procure or access, potential for sponsored agreements that bring new research funding for
student wages, equipment, and student travel, and potential for industry experience through internships, applied problems, and post-graduation employment. Because the Company strongly emphasizes open science, student work stays publishable, so
a graduate thesis, a paper, or a conference talk is not delayed. In light of these potential benefits, a plan to manage potential conflicts that may arise from the Faculty Member's engagement in this outside activity is detailed below.
...
Property Policy}. The \href{https://policy.byu.edu/view/appropriate-use-of-information-technology-resources-policy}{Appropriate
Use of Information Technology Resources Policy} reaches ``all individuals and
entities who maintain or use IT Resources,'' counts BYU's ``networks and
networking systems'' among them, and bars use ``for non-university commercial
purposes'' absent written authorization from the responsible vice president
and the chief information officer.} All Company work runs on Company-owned
laptops, accounts, software, and storage, and on campus Company business
travels on the Company's own connection rather than a BYU network, guest
access included. No Company data
on BYU systems, and no non-public BYU information on Company systems.
...
of Time or Interest Policy} defines ``Incidental Use'' as ``occasional or
infrequent personal use that results in little or no cost to the university.'' The
...
campus office for business purposes.'' A chair's signature alone does not clear
the 6.1 prohibition, which carries no chair-level waiver.}
