...
\clause{6.2} \textbf{Campus office.} The campus office is not a Company
workplace: no Company staff, no Company records or equipment kept there, no
customer or investor meetings, and nothing that displaces university work or
puts a cost on the university. Occasional Company calls and correspondence on
Company devices are incidental use of the office, and this plan asks the \textbf{dean
and the AAVP} to authorize that in writing alongside the outside
role.\footnote{\href{https://policy.byu.edu/view/conflict-of-time-or-interest-policy}{Conflict
