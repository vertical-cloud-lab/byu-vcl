...
faculty appointment, not on leave. Any change to the facts in this section
requires an amendment \emph{first} (section 10); ownership is updated after
each financing under section 9.
...
bonuses, or expense-paid travel. Stock is the only financial
...
\clause{1.4} \textbf{The inventor's royalty share is forfeited.} At ten
...
\clause{1.5} \textbf{No voting board seat}, and no observer seat unless the
...
\clause{1.6} \textbf{Neither role speaks for the other.} The Faculty Member
...
No salary, fees, bonuses, or paid travel (1.3), and a forfeited royalty share
(1.4). What remains is unsellable private stock, which no single favorable
term turns into money. \\
\addlinespace
...
\href{https://facultyprofile.byu.edu/}{Faculty Profile} & annually & chair \\
Financial disclosure & annually, updated within 30 days & Research
Administration Office \\
Time log (2.1), advocate's student review (5.1), and independent reviewer's
report (4.2) & annually & chair, and the AAVP for the reviewer's report \\
...
no use of BYU's name (1.6), no informal approaches to students (5.4, 6.3), and
...
{\setlength{\extrarowheight}{3pt}\small
...
monitors compliance (9.1) & \sigline \\[0.5em]
\ph, Dean, Ira A.\ Fulton College of Engineering & approves the
outside-activity conflict plan & \sigline \\[0.5em]
...
Administration Office (research and equipment agreements), the Technology
Transfer Office (license and invention provisions), Regulatory Accounting
(cost-recovery rates), and the Office of General Counsel (license review).
Those approvals attach to the transactions, not to this document.}
