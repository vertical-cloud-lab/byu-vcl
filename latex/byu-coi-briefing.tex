...
\noindent \textbf{Nor is a student job at the Company settled by prohibition.}
No BYU rule stops a graduate student from working there, and none stops it
because the faculty member supervises the thesis. The
\href{https://policy.byu.edu/view/financial-conflict-of-interest-in-research-policy}{Financial
Conflict of Interest in Research Policy} puts ``[u]sing university employees
(e.g., students or staff) to perform services for an outside entity in which
the Investigator \ldots\ has an equity ownership'' among the interests a
management plan addresses rather than on any prohibited list, and the
\href{https://policy.byu.edu/view/conflict-of-time-or-interest-policy}{Conflict
of Time or Interest Policy} asks a student working ``on the same issue for BYU
and a third-party'' to disclose it and then have the conflict ``reduced,
eliminated, or appropriately managed.'' The categorical bar BYU does write is
about family: the Internships Policy forbids credit under the supervision of
``immediate family members'' and internships at organizations they own or
manage, and says nothing about a faculty advisor's own company.
\href{https://web.stanford.edu/group/OTL/documents/bp_faculty_sus.pdf}{Stanford}
tells faculty founders not to ``involve current students in company
activities'' at all, but that is Stanford's rule. So the plan manages the risk
instead of removing the opportunity: independent advice before an offer is
accepted, a chair who knows, Company work directed by someone else, academic
judgment left to the committee (clauses 5.4, 5.5).
...
while the stakes are small, is the dated record that answers scrutiny if the
company succeeds.
...
Signature authority is set by what an agreement costs and how long it binds
the university, not by what kind of agreement it is. A faculty member sits in
the bottom row, which is why the plan's equipment and research agreements are
signed well above the lab.
...
(4.3). \textbf{Pressure on students} is answered by voluntary participation, a bar
on retaliation, and a commitment to keep other funding available (5.2), an
advocate outside the lab who meets them alone (5.1), review of any Company
offer with academic judgment left to the committee (5.4, 5.5), and one
employer at a time (5.3).
\textbf{The two roles merging} is prevented by Company work on Company systems
and the Company's own network connection, guest access included, since the
\href{https://policy.byu.edu/view/appropriate-use-of-information-technology-resources-policy}{IT
policy} governs the university's ``networks and networking systems'' and so
follows the network rather than the login (6.1); by personnel and equipment
admitted only under signed agreements (6.3, 6.4); and by a Company officer
signing the promises made about Company conduct (8.3).

% =============================================================== formation ==
\parthead{Company formation documents, and the line they must respect}

Standard formation packages have founders buy shares partly with intellectual
property and have everyone assign inventions made \emph{before} as well as
after incorporation. Stripe Atlas, the most common, says both in its
...
A contribution is only as good as the founder's title to it, and BYU's claim
attaches automatically: employees ``agree to assign and do hereby
...
with them to edit the documents you receive from Stripe Atlas,'' the annotated
templates issued on the same dashboard for counsel to edit.
...
university's, and it represents that signing ``does not and will not breach
any agreement or duty which the employee has with anyone else.'' A blank
schedule leaves both untouched. So does BYU's
...
\begin{itemize}
\item Before any U.S.\ Public Health Service money (National Institutes of
Health, for example) is spent, BYU must answer public requests about disclosed
financial interests within five business days.
...
default and sends over only what the open-source policies do not cover (7.1,
7.2). Public release costs foreign patent rights the day it happens, so the
office may want that line drawn elsewhere.
...
\href{https://spo.byu.edu/00000190-3687-d777-a591-37af392d0001/rechargecenterpolicyprocedures-pdf}{Recharge
Center Policy} sits outside the policy library (a search of all 195 returns
nothing for recharge, service center, or external rate) and still names a
director ``currently (June 2005).'' Confirm the current version before
proposing a rate.
\item \textbf{For Faculty Relations:} the one-day-a-week
supplemental-compensation cap and the four-days-a-month outside-activity cap
govern different things but consume the same time. Whether they stack is left
open rather than guessed at.
\item \textbf{For the Research Administration Office:} ``Appendix A, COI
Management Plan Approval and Appeal Process,'' referenced by the research
conflict policy but not published.
\end{itemize}

\vspace{6pt}
{\color{metagray}\footnotesize\noindent
Rules cited from sign-in policies at
\href{https://policy.byu.edu}{policy.byu.edu} follow an authenticated review of
the full library in July and August 2026. Documents of record: the two
\texttt{.tex} sources in
